...
public class application extends JFrame{
    ...
    public void initializeView() {
        ...
        {
            SpeakerLabel.setIcon(new ImageIcon("src\\project\\java\\pictures\\speaker.png"));
        ...
        {
            LogoLabel.setIcon(new ImageIcon("src\\project\\java\\pictures\\logov2.png"));
        ...
        {
            HelpLabelIcon.setIcon(new ImageIcon("src\\project\\java\\pictures\\25x25\\help.png"));
        ...
        {
            AboutLabelIcon.setIcon(new ImageIcon("src\\project\\java\\pictures\\25x25\\about.png"));
        ...
        {
            HelpLabel.setIcon(new ImageIcon("src\\project\\java\\pictures\\HelpWindow.png"));
        ...
        {
            AboutLabel.setIcon(new ImageIcon("src\\project\\java\\pictures\\AboutWindow.png"));
        ...
        {
            PlayButton.setIcon(new ImageIcon("src\\project\\java\\pictures\\playButton.png"));
        ...
        PreviousButton = new JButton();
        {
            ...
            PreviousButton.setIcon(new ImageIcon("src\\project\\java\\pictures\\previousButton.png"));
        ...
        NextButton = new JButton();
        {
            ...
            NextButton.setIcon(new ImageIcon("src\\project\\java\\pictures\\nextButton.png"));
        ...
        RandomPlayButton = new JButton();
        {
            ...
            RandomPlayButton.setIcon(new ImageIcon("src\\project\\java\\pictures\\randomButton1.png"));
        ...
        {
            ChooseDirectoryButton.setIcon(new ImageIcon("src\\project\\java\\pictures\\folder.png"));
        ...
        {
            SpeakerButton.setIcon(new ImageIcon("src\\project\\java\\pictures\\speaker.png"));
